...
export function MarkdownView({ markdown, className }: { markdown: string; className?: string }) {
  return (
    <div
      className={cn(
        'prose prose-neutral max-w-none prose-headings:scroll-mt-24 prose-headings:font-bold prose-headings:tracking-[-0.025em] prose-headings:text-fd-foreground prose-h2:mb-4 prose-h2:mt-10 prose-h2:text-[30px] prose-h2:leading-[1.5] prose-h3:mb-3 prose-h3:mt-8 prose-h3:text-[20px] prose-h3:leading-[1.5] prose-h4:mb-3 prose-h4:mt-6 prose-h4:text-[16px] prose-h4:leading-7 prose-p:my-4 prose-p:pr-px prose-p:text-[16px] prose-p:leading-7 prose-p:text-[color:var(--docs-body-copy,var(--fd-muted-foreground))] prose-li:pr-px prose-li:text-[16px] prose-li:leading-7 prose-li:text-[color:var(--docs-body-copy,var(--fd-muted-foreground))] prose-strong:text-[color:var(--docs-body-copy,var(--fd-foreground))] prose-a:font-semibold prose-a:text-[color:var(--docs-link,var(--fd-primary))] prose-a:underline prose-a:decoration-[color:var(--docs-link-underline,var(--fd-primary))] prose-a:decoration-[1.5px] prose-a:underline-offset-4 hover:prose-a:text-[color:var(--docs-link-hover,var(--fd-primary))] hover:prose-a:decoration-current prose-code:rounded-md prose-code:bg-fd-muted prose-code:px-1.5 prose-code:py-0.5 prose-code:text-[0.875em] prose-code:text-fd-foreground prose-pre:overflow-x-auto prose-pre:rounded-2xl prose-pre:border prose-pre:border-fd-border prose-pre:bg-[#0f172a] prose-pre:p-4 prose-pre:text-[13px] prose-pre:leading-6 prose-pre:text-slate-100 prose-pre:shadow-sm prose-pre:[&_code]:whitespace-pre prose-pre:[&_code]:bg-transparent prose-pre:[&_code]:p-0 prose-pre:[&_code]:text-inherit prose-blockquote:border-l-[3px] prose-blockquote:border-fd-border prose-blockquote:text-[color:var(--docs-body-copy,var(--fd-muted-foreground))] prose-hr:border-fd-border',
        className,
      )}
    >
      <ReactMarkdown
