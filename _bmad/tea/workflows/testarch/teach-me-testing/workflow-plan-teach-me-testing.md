...
**Location:** {external-project-root}/docs/bmb-creations/workflows/teach-me-testing/
...
**Source (Staging):**
`{external-project-root}/docs/bmb-creations/workflows/teach-me-testing/`
...
```bash
cp -r {external-project-root}/docs/bmb-creations/workflows/teach-me-testing \
